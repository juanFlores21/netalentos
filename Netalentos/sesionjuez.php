            ...
            <div class="form-value">
                ...
                <center>
                    <div class="btn-group justify-content-center" role="group" aria-label="Basic example">
                        <button type="tipoUs" class="btn btn-secondary" onclick="window.location.href='iniciarSesion.php'">
                        ...
                        <button type="tipoUs" class="btn btn-secondary" onclick="window.location.href='sesionJuez.php'">
                            <div class="button-content">
                        ...
                        <button type="tipoUs" class="btn btn-secondary" onclick="window.location.href='sesionAdmin.php'">
                            <div class="button-content">
                ...
                <form action="valida/loginJuez.php" method="post">
                    <!-- INICIAR SESION -->
