...
if ($correo !== $correo_original) {
    ...
    $sql_check_email = "SELECT idParticipante FROM Participante WHERE email = ? AND idParticipante != ?";
    $stmt_check_email = $conn->prepare($sql_check_email);
    $stmt_check_email->bind_param("si", $correo, $idParticipante);
...
$stmt->bind_param("sssssssiii", $nombre, $apPaterno, $apMaterno, $correo, $edad, $fechaNacimiento, $calle, $numero, $codigoPostal, $idParticipante);
